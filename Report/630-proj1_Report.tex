...
% explain diagram in writing (high level)
% user writes python, compiles using "compileall" module
% user opens "app.html" in browser, uploads *.pyc file
% file passed to parser, parser passes pyo.PyCodeObject to stack-based interpreter
