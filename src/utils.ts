/*
More or less stolen from https://github.com/basarat/typescript-collections (because I can't get the module to work with Node)
 */

/* some helper functions stolen from doppio */
//stolen from doppio
...
export class Dict<V> {
    ...
    contains(key: string): boolean {
        ...
        for (var i = 0; i < this._keys.length; i++) {
            if (this._keys[i] == key) result = true;
        }
        return result;
    }
